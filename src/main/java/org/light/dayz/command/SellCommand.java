...
public class SellCommand implements CommandExecutor {
    ...
    public void openSellGUI(Player p) {
        ...
        inv.setItem(1, Regen.createItemStack(Material.DIAMOND_SWORD, "§c[ §f! §c] §f총기 판매", (short) 0, " ", " §8-  §f총을 1개당 썩은고기 1~5개(스킨의 경우 5~15개)에 판매합니다. 스킨 취급받는 일반 무기가 존재할 수 있습니다.", " §8-  §7[ §f좌클릭 §7] §f손에 든 총기 판매", " §8-  §7[ §f쉬프트 + 좌클릭 §7] §f모두 판매", " "));
